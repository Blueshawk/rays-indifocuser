...
int speed = 100; //for changing speeds during use
int backlash = 0;
...
#define motorPin1  6       // IN1 on UL2003
#define motorPin2  8      // IN2 on UL2003
#define motorPin3  7       //  IN3 on UL2003
#define motorPin4  9       //  IN4 on UL2003
int STEPS = 4;            // 28BYJ-48 steps 4 or 8

// Define a stepper and the pins it will use
AccelStepper stepper(STEPS, motorPin1, motorPin2, motorPin3, motorPin4);
